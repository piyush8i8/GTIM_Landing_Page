...
// // Dummy data for 10 partner universities
// const universities = [
//   {
...
//             <div
//               key={idx}
//               className="bg-white rounded-2xl shadow-md hover:shadow-lg transition transform hover:scale-105 p-4 w-64 text-center flex-shrink-0"
//             >
//               <img
//                 src={uni.img}
//                 alt={uni.name}
